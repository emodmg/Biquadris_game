    ...
    while (true) {
        while (g1.players[0]->is_playing) {
            ...
            if (cmd == "left") {
                ...
                if (g1.players[0]->blind) {
                    g1.players[0]->blind = false;
                    td.isBlind1 = false;
                }
                ...
                if (rowsRemoved >= 2) {
                    std::cout << "Please specify your special action" << std::endl;
                    std::string specialAction;
                    std::cin >> specialAction;
                    if (specialAction == "heavy") {
                        g1.players[1]->heavy = true;
                    } else if (specialAction == "force") {
                        std::cout << "Please specify your force type" << std::endl;
                        std::string type;
                        std::cin >> type;
                        if (type == "I") {
        ...
        while (g1.players[1]->is_playing) {
            ...
            if (cmd == "left") {
                ...
                if (g1.players[1]->blind) {
                    g1.players[1]->blind = false;
                    td.isBlind2 = false;
                }
